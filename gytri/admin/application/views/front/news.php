	...
	<section class="page-top-section set-bg" data-setbg="<?php echo base_url()?>loans2go/img/page-top-bg/3.jpg">
		<div class="container">
			<h2>News</h2>
	...
	<section class="blog-section spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-post">
						<img src="<?php echo base_url()?>loans2go/img/news/1.jpg" alt="">
						...
						<a href="#" class="readmore">Read More <img src="<?php echo base_url()?>loans2go/img/arrow.png" alt=""></a>
					</div>
					<div class="blog-post">
						<img src="<?php echo base_url()?>loans2go/img/news/2.jpg" alt="">
						<div class="blog-date">Apr 08, 2019</div>
					...
					<div class="blog-post">
						<img src="<?php echo base_url()?>loans2go/img/news/3.jpg" alt="">
						<div class="blog-date">Apr 08, 2019</div>
				...
				<div class="col-lg-4 col-md-6 sidebar">
					<div class="sb-widget">
						<form class="search-form">
							...
							<button><img src="<?php echo base_url()?>loans2go/img/search-icon.png" alt=""></button>
						</form>
					</div>
					<div class="sb-widget">
					...
					<div class="sb-widget">
						<a href="#" class="add">
							<img src="<?php echo base_url()?>loans2go/img/add.jpg" alt="">
						</a>
					</div>
				</div>
			</div>
