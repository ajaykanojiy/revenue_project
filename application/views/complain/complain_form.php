                                ...
                                <div class="row" style="<?php echo $block_style; ?>">
                                    ...
                                    <div class="col-xs-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="com_subcategory" id="com_subcategory">
                                                 ...
                                                 <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="4" name="com_details" id="com_details" placeholder="Compalint Details"><?php echo $com_details; ?></textarea>
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <div class="alert alert-danger" style="<?php echo $block_style; ?>">
                                                <span>Employee To customer Remark</span>
                                            </div>
                                            ...
                                            <div class="row" style="<?php echo $block_style; ?>">
                                                ...
                                                <div class="col-xs-6">
                                                    ...
                                                    </div>   <!-- end Emp to customer Remark -->

                                                    <div class="alert alert-danger" style="<?php echo $block_hide; ?>">

                                                        <h4>Intenal closure Remark</h4>

                                                    </div>
                                                     <div class="row" >
                                                     <div class="col-xs-12" style="<?php echo $block_hide; ?>">
                                                                <div class="form-group">

                                                                    <label for="int">Intenal closure Remark <?php echo form_error('payment_mode') ?></label>
                                                    ...
                                                    <div class="alert alert-danger" style="<?php echo $blo_hide; ?>">

                                                        <h4>Employee to Vender Remark</h4>

                                                    </div>
                                                    <div class="row" style="<?php echo $blo_hide; ?>">
                                                        <div class="col-xs-6">

                                                         <div class="form-group">

                                                            <label for="varchar">Bill <?php echo form_error('warranty') ?></label>

                                                            <input type="text" class="form-control" name="Bill" id="bill" placeholder="Bill" value="<?php echo $bill; ?>" />
                                                        ...
                                                        ?>
                                                        <div class="row" id="vender_block" style="<?php echo $style;$blo_hide; ?>">
