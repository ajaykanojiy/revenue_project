        ...
        <li class="treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('report/report_form') ?>"><i class="fa fa-circle-o"></i>Revnue Report</a></li>
            <li><a href="<?php echo base_url('report/emp_report') ?>"><i class="fa fa-circle-o"></i>Emp To Emp Report</a></li>
            <li><a href="<?php echo base_url('report/expreport_form') ?>"><i class="fa fa-circle-o"></i>Expense Report</a></li>
            <li><a href="<?php echo base_url('report/profit_report') ?>"><i class="fa fa-circle-o"></i>Net Profit</a></li>
     ...
     <li class="header">Setting</li>
        ...
        <!--    <li><a href="<?php echo base_url('payment_mode') ?>"><i class="fa fa-circle-o"></i>Payment mode</a></li>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('vender') ?>"><i class="fa fa-circle-o"></i>Create Vendor</a></li>

            <li><a href="<?php echo base_url('vender_type') ?>"><i class="fa fa-circle-o"></i>Crate Vendor Type</a></li>
          ...
          <a href="#">
            ...
            <i class="fa fa-table"></i> <span>Expense Category</span>
           ...
           <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('expense_category') ?>"><i class="fa fa-circle-o"></i>Create Expense Category</a></li>

            <li><a href="<?php echo base_url('expense_subcategory') ?>"><i class="fa fa-circle-o"></i>Create Expense SubCategory</a></li>
          ...
          <li class="header">Complain Setting</li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('com_category') ?>"><i class="fa fa-circle-o"></i>Create Category</a></li>

            <li><a href="<?php echo base_url('com_sub_category') ?>"><i class="fa fa-circle-o"></i>Create Subcategory</a></li>
