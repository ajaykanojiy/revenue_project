<div class="content-wrapper">
    ...
    <section class="content">
	    ...
	    <tbody>
		    ...
		    <td><a href="<?php echo base_url('customer/profile/'.$customer->id) ?>">                             <?php echo $customer->name.'--'.$customer->id ?></a></td>
            ...
            <td><span class="btn <?php echo $colur; ?> "><?php echo ($customer->booking_status==1)?'available':'Booked'; ?></span></td>
            <!-- <td><?php echo ($customer->customer_type=='c')?'Customer':'Guest'; ?></td> -->
