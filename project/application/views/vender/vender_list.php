<div class="content-wrapper">
    ...
    <section class="content">
	    ...
	    <tbody>
            ...
            <td><?php echo $vender['vendor_name'] ?></td>
		    <td><?php $res=$this->Vender_type_model->get_by_id($vender['vendor_type']);echo $res->name ?></td>
		    <td><?php echo $vender['vdor_business'] ?></td>
		    <td><?php $res=$this->Building_model->get_by_id($vender['building_id']);echo $res->name;?></td>
