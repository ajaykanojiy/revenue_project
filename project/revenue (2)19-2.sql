...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2020 at 01:47 PM
...
(3, '2020-02-17', 473, 2, 1, 'dsgsgg', 6, 5, 1, 4, 2, 1, 65, 'fdsf', '', '', 0, '', '', 0, '', '', '', 0);
...
INSERT INTO `income_register` (`register_id`, `customer_id`, `employee_id`, `other_emp_id`, `income`, `expense`, `mode`, `other_mode`, `comment`, `key_value`) VALUES
(1, 2, 7, 0, 2000, 0, 1, 0, '', ''),
(2, 0, 7, 6, 0, 500, 1, 0, '  FG', ''),
(3, 0, 6, 7, 500, 0, 1, 0, '  FG', ''),
(4, 2, 7, 0, 1000, 0, 2, 0, '', ''),
(5, 0, 7, 6, 0, 500, 2, 0, '  fgygy', ''),
(6, 0, 6, 7, 500, 0, 2, 0, '  fgygy', ''),
(7, 4, 6, 0, 1000, 0, 3, 0, '', ''),
(8, 2, 9, 0, 501, 0, 1, 0, '', ''),
(9, 0, 9, 8, 0, 200, 1, 0, '  g', ''),
(10, 0, 8, 9, 200, 0, 1, 0, '  g', ''),
