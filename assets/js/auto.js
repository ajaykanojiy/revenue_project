...
$(".addmore").on('click',function(){
	...
	html += '<td><input type="text" data-type="productCode" name="itemNo[]" value=" Box - '+i+' |  Item - '+i+'" id="itemNo_'+i+'" class="form-control autocomplete_txt" autocomplete="off"></td>';
